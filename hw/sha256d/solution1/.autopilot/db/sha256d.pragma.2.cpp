...
_ssdm_SpecArrayPartition( &sha256_k, 1, "COMPLETE", 0, "");
 unsigned W[64];
...
_ssdm_op_SpecInterface(work, "s_axilite", 0, 0, "", 0, 0, "CTRL_BUS", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(target, "s_axilite", 0, 0, "", 0, 0, "CTRL_BUS", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(max_nonce, "s_axilite", 0, 0, "", 0, 0, "CTRL_BUS", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(num_hashes, "s_axilite", 0, 0, "", 0, 0, "CTRL_BUS", "", "", 0, 0, 0, 0, "", "");
...
_ssdm_SpecArrayPartition( midstate, 1, "COMPLETE", 0, "");

 unsigned upper[16];
_ssdm_SpecArrayPartition( upper, 1, "COMPLETE", 0, "");
...
# 628 "sha256d/sha256d.cpp"
 do
 {
_ssdm_op_SpecLoopTripCount(1, 4000000000, 2000000000, "");
